...
Generado 2026-07-30 (con estado de Firestore).
...
| SIN_FUENTE_MAPEADA | 628 | 34.2% | **Nosotros** |
| FUENTE_NO_ACCESIBLE | 0 | 0.0% | **Nosotros** |
| SIN_DATO_REPORTADO | 499 | 27.2% | Focus |
| CON_DATO_REPORTADO | 28 | 1.5% | — |
...
- **I.10 · Existe plan de acción familia escuela actualizado**: 23 tuplas — Existe plan actualizado — probablemente derivable del tab Actividades, junto a I.9. Confirmar con Sebastián.
...
- **I.13 · Director asiste a módulos formativos**: 23 tuplas — Director asiste a módulos formativos. Sin fuente declarada. Confirmar planilla.
- **I.14 · Coordinador asiste a módulos formativos**: 23 tuplas — Coordinador asiste a módulos formativos. Sin fuente declarada. Confirmar planilla.
...
- **I.21 · Número de talleres para apoderados presenciales realizados en promedio**: 23 tuplas — Nº talleres presenciales por sala. Sin fuente declarada.
- **I.22 · %  promedio de asistencia anual de apoderados a taller para apoderados**: 23 tuplas — Se reporta por Encuesta Apoderados, tab estructurada pero sin datos hoy.
- **I.23 · Número de Taller digitales para Apoderados enviados en promedio por sa**: 23 tuplas — Nº talleres digitales enviados por sala. Sin fuente declarada.
- **I.24 · Cantidad de visualizaciones promedio de los Talleres digitales para Ap**: 23 tuplas — Visualizaciones de talleres digitales. Sin fuente declarada.
...
- **I.29 · Cantidad  promedio de libros de Bibliotecas Viajeras recibidos por est**: 23 tuplas — Libros de BV recibidos por estudiante. Encuesta Apoderados. Sin datos hoy.
- **I.30 · Cantidad promedio de envío de Lecturas Viajeras por sala**: 23 tuplas — Envío de Lecturas Viajeras. Encuesta Apoderados. Sin datos hoy.
- **I.31 · % de salas que envían Mantel de Palabras**: 23 tuplas — Salas que envían Mantel. Encuesta Apoderados. Sin datos hoy.
- **I.32 · Número de talleres para estudiantes realizados por sala (1ro a 8vo)**: 23 tuplas — Nº talleres para estudiantes. Sin fuente declarada.
...
- **I.39 · Porcentaje de Talleres para Apoderados liderados por la dupla monitor **: 23 tuplas — % Talleres liderados por dupla monitor-profesor. Sin fuente declarada.
...
- **I.42 · % de apoderados que responden la encuesta que declaran haber descargad**: 23 tuplas — Se reporta por Encuesta Apoderados, tab estructurada pero sin datos hoy.
- **I.43 · Promedio de libros de Biblioteca Viajera que declaran utilizar las fam**: 23 tuplas — BV que declaran usar familias. Encuesta Apoderados. Sin datos hoy.
- **I.44 · Promedio de Lecturas Viajeras que declaran utilizar las familias que r**: 23 tuplas — LV que declaran usar familias. Encuesta Apoderados. Sin datos hoy.
- **I.45 · % de apoderados que contestan la encuesta y declaran utilizar el mante**: 23 tuplas — Mantel que declaran usar familias. Encuesta Apoderados. Sin datos hoy.
...
- **I.48 · Cantidad promedio de actividades  mediación Biblioteca Viajera realiza**: 23 tuplas — Mediación BV. Sin fuente declarada.
- **I.49 · Cantidad promedio de actividades de aula de Lecturas Viajeras desarrol**: 23 tuplas — Mediación LV. Sin fuente declarada.
